...
def make_bolsig_script(collision_file, script_path, output_name='bolsig_output.dat', species='Ar'):
...
def run_bolsig(bolsig_executable, script_path, work_dir=None, timeout=120):
    ...
    cmd = [str(bolsig_executable), str(script_path)]
    try:
...
if __name__ == '__main__':
    ...
    make_bolsig_script(collision_name, script_path, output_name=args.output_name, species=args.species)
